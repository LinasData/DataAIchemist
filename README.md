...
<!-- <br>
 ...
 ### I'm a medicinal chemist and a data analytics expert who loves difficult and exciting tasks. I am the author of the best 2022 Lithuania master's thesis in the fields of medicine and health.  Helping professionals in medicine with solutions in data engineering and analytics. Contributing to Lithuania Open Data initiative. My solutions 
...
* **Databases and Storage:** SQL, MySQL, PostgreSQL, MongoDB, Microsoft SQL Server, AWS S3

* **Programming languages:** Python, R, Java, Scala, SQL, VBA, HTML, CSS, JavaScript

* **Development:** Git, Linux (Kali, Ubuntu), Visual Studio, Jupyter Notebook, Vim, Terminal

* **Data Processing and Analytics:** Spark, Airflow, Ogr2ogr, Pandas, Tidyverse, ArcPy, GeoPandas, Google Sheets, numpy

* **Data 

* **Development:** Git, Linux and Docker.

* **Data Visualization:** Seaborn, Matplotlib, Plotly, r-base, 
